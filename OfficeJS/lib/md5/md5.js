...
(function() {
    ...
    var integer = function (n) { return n%(0xffffffff+1); };

    var shr = function (a,b) {
        a=integer(a);
        b=integer(b);
        if (a-0x80000000>=0) {
            a=a%0x80000000;
    ...
    var state = newArray(4);
    var count = newArray(2);
    count[0] = 0;
    count[1] = 0;
    var buffer = newArray(64);
    var transformBuffer = newArray(16);
    var digestBits = newArray(16);
    ...
    var transform = function (buf,offset) {
        var a=0, b=0, c=0, d=0;
