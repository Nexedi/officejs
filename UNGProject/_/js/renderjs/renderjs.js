var TabbularGadget = {
  ...
  addNewTabGadget: function(form_id, dom_id){
    ...
    window.setTimeout("RenderJs.updateGadgetData(tab_gadget)", 1000);
  }
  ...
  update: function(data){
              ...
              $.each(data['form_data'],
                     function(field_id, field_dict){
                        ...
                        if (type=="EditorField"){
                          dom = Form.EditorField(field_id, field_dict);}
...
$(document).ready(function() {
   RenderJs.bootstrap($("#top_menu"));
   RenderJs.bootstrap($("#header"));
