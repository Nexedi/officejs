	...
	sheet: function(settings) {
		jQuery(this).each(function() {
			...
			var set = jQuery.extend({
				urlGet: 			"jquery.sheet/sheets/enduser.documentation.html", //local url, if you want to get a sheet from a url
				urlSave: 			"jquery.sheet/save.html", 					//local url, for use only with the default save for sheet
				...
				urlMenu: 			"jquery.sheet/menu.html", 					//local url, for the menu to the left of title
	...
	createInstance: function(s, I, origParent) { //s = jQuery.sheet settings, I = jQuery.sheet Instance Integer
		...
		var jS = {
			...
			obj: {//obj = object references
				...
				tab:				function() { DebugI=I;			//for the tab show bug of saving
			...
			id: {
				...
				*/
				...
				tab:				'jSheetTab_' + I + '_',
				tabContainer:			'jSheetTabContainer_' + DebugI,
